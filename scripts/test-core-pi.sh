...
live_route_match_endpoint_require_unambiguous="${VISUAL_HOMING_LIVE_ROUTE_MATCH_ENDPOINT_REQUIRE_UNAMBIGUOUS:-0}"
live_route_match_allow_ambiguous_endpoint_hold="${VISUAL_HOMING_LIVE_ROUTE_MATCH_ALLOW_AMBIGUOUS_ENDPOINT_HOLD:-0}"
live_route_match_top_k_diagnostics="${VISUAL_HOMING_LIVE_ROUTE_MATCH_TOP_K_DIAGNOSTICS:-0}"
live_route_match_top_k="${VISUAL_HOMING_LIVE_ROUTE_MATCH_TOP_K:-5}"
live_route_match_zone_probes="${VISUAL_HOMING_LIVE_ROUTE_MATCH_ZONE_PROBES:-0}"
live_route_match_edge_diagnostics="${VISUAL_HOMING_LIVE_ROUTE_MATCH_EDGE_DIAGNOSTICS:-0}"
...
for bool_env in \
    ...
    VISUAL_HOMING_LIVE_ROUTE_MATCH_ENDPOINT_REQUIRE_UNAMBIGUOUS \
    VISUAL_HOMING_LIVE_ROUTE_MATCH_ALLOW_AMBIGUOUS_ENDPOINT_HOLD \
    VISUAL_HOMING_LIVE_ROUTE_MATCH_TOP_K_DIAGNOSTICS \
    VISUAL_HOMING_LIVE_ROUTE_MATCH_ZONE_PROBES \
    VISUAL_HOMING_LIVE_ROUTE_MATCH_EDGE_DIAGNOSTICS \
    VISUAL_HOMING_LIVE_ROUTE_MATCH_DIRECTIONAL_SEARCH \
