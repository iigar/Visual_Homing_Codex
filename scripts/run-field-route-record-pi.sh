...
keyframe_root="${VISUAL_HOMING_KEYFRAME_DIR:-${repo_root}/keyframes}"
route_keyframe_dir="${VISUAL_HOMING_ROUTE_KEYFRAME_DIR:-${keyframe_root}/field-route-${stamp}-keyframes}"
