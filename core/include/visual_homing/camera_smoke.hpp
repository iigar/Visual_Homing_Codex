...
struct LiveRouteMatchingConfig {
    ...
    bool focus_roi_diagnostics = false;
    double focus_roi_left_fraction = 0.12;
    double focus_roi_right_fraction = 0.12;
    double focus_roi_top_fraction = 0.08;
    double focus_roi_bottom_fraction = 0.22;
    std::size_t focus_roi_top_count = 5;
...
struct LiveRouteMatchingResult {
    ...
    std::uint64_t focus_roi_frames = 0;
    std::uint64_t focus_roi_valid_matches = 0;
    std::uint64_t focus_roi_route_index_agreements = 0;
    std::uint64_t focus_roi_endpoint_agreements = 0;
    double focus_roi_valid_fraction = 0.0;
    double focus_roi_route_index_agreement_fraction = 0.0;
    double focus_roi_endpoint_agreement_fraction = 0.0;
    double focus_roi_confidence_min = 0.0;
    double focus_roi_confidence_avg = 0.0;
    double focus_roi_first_progress = 0.0;
    double focus_roi_last_progress = 0.0;
    double focus_roi_min_progress_seen = 0.0;
    double focus_roi_max_progress_seen = 0.0;
    double focus_roi_top_match_gap_min = 0.0;
    double focus_roi_top_match_gap_avg = 0.0;
