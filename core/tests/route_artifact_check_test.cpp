...
int main() {
    ...
    assert(repetitive_distinctiveness.first_evaluated_frame_id == 0);
    assert(repetitive_distinctiveness.last_evaluated_frame_id == 2);
    assert(repetitive_distinctiveness.first_evaluated_route_time_ms == 0.0);
    assert(repetitive_distinctiveness.last_evaluated_route_time_ms == 0.000002);
    ...
    assert(repetitive_distinctiveness.low_texture_samples.size() == 3);
    assert(repetitive_distinctiveness.low_texture_samples[0].frame_id == 0);
    assert(repetitive_distinctiveness.low_texture_samples[0].route_time_ms == 0.0);
    assert(repetitive_distinctiveness.exact_duplicate_samples.size() == 2);
    assert(repetitive_distinctiveness.exact_duplicate_samples[0].frame_id == 0);
    assert(repetitive_distinctiveness.ambiguous_nearest_samples.size() == 3);
    assert(repetitive_distinctiveness.ambiguous_nearest_samples[2].frame_id == 2);
    assert(repetitive_distinctiveness.ambiguous_nearest_samples[2].route_time_ms == 0.000002);
    ...
    assert(trimmed_distinctiveness.first_evaluated_frame_id == 2);
    assert(trimmed_distinctiveness.last_evaluated_frame_id == 5);
    ...
    assert(textured_distinctiveness.low_texture_samples.empty());
    assert(textured_distinctiveness.exact_duplicate_samples.empty());
    assert(textured_distinctiveness.ambiguous_nearest_samples.empty());
