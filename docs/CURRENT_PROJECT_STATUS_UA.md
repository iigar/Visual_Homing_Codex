...
- При відновленні прочитати цей snapshot, `BOARD_RECORDING_INVENTORY_2026-09-22_UA.md`, `SOFTWARE_VALIDATION_2026-09-21_UA.md` і найновіший запис `SESSION_LOG.md`. Наступний обмежений software крок може використовувати вже локальні маршрути для відтворюваного benchmark/аналізу артефактів; незалежна перевірка точності потребує окремого другого проходу з розміткою. До запуску камери або апаратної перевірки як частини software slice не переходити.
