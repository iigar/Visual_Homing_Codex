...
This is separate from the ordinary fail-closed wrapper evidence. It proves the reviewed attach build can attach the writer while the safety gate still blocks command output. It is not flight, tethered-flight, ground-movement, or autonomous-return evidence.
