...
/home/pi/Visual_Homing_Codex/artifacts/stop_frames/endpoint-stop-frame-20260710T171335Z-id-690-route-599.pgm
```
...
progress_gate_passed=true
endpoint_stop=true
endpoint_dwell_ms=1200.36
endpoint_dwell_required_ms=1200
endpoint_dwell_passed=true
endpoint_stop_frame_written=true
endpoint_stop_frame_id=690
endpoint_stop_frame_size=160x100
endpoint_stop_route_index=599
endpoint_stop_progress=1
endpoint_stop_tracked_progress=1
endpoint_stop_confidence=0.87015
stop_reason=endpoint_progress_reached
telemetry_health=true
dry_run_quality=true
dry_run_valid=538/538
external_nav_valid=538/538
external_nav_valid_fraction=1
...
external_nav_operator_readiness=ready
external_nav_operator_reason=valid
confidence_min_avg=0.861943/0.888832
external_nav_output_block_reasons=runtime_disabled:538
```

Repeat stop-frame event:

```text
endpoint_stop_frame_path=/home/pi/Visual_Homing_Codex/artifacts/stop_frames/endpoint-stop-frame-20260710T171335Z-id-690-route-599.pgm
endpoint_stop_frame_id=690
endpoint_stop_route_index=599
endpoint_stop_progress=1
endpoint_stop_tracked_progress=1
...
Repeat audit checker:

```text
external_nav_output_audit_log_check path=/home/pi/Visual_Homing_Codex/artifacts/logs/external-nav-output-audit-20260710T171252Z.log passed=true estimates=538 allowed=0 sent=0 blocked=538 reason=runtime_disabled stop_reason=endpoint_progress_reached
external_nav_output_attach_check passed=true
```

## Reverse Endpoint Observation

Reverse attach-only checks on the same route reached the physical start/end zone correctly when run with reverse expected progress and an endpoint start threshold near `0.08`.

Best repeat after camera alignment:

```text
log=/home/pi/Visual_Homing_Codex/artifacts/logs/external-nav-output-attach-20260710T170003Z.log
frames=547/1200
valid_matches=547
progress=0.851419..0
tracked_progress=0.851419..3.94124e-11
endpoint_stop=true
endpoint_dwell_ms=1229.07
endpoint_dwell_required_ms=1200
endpoint_dwell_passed=true
endpoint_stop_frame_written=true
endpoint_stop_frame_path=/home/pi/Visual_Homing_Codex/artifacts/stop_frames/endpoint-stop-frame-20260710T170046Z-id-699-route-0.pgm
endpoint_stop_frame_id=699
endpoint_stop_route_index=0
endpoint_stop_progress=0
endpoint_stop_tracked_progress=3.94124e-11
endpoint_stop_confidence=0.844399
external_nav_valid=534/547
external_nav_valid_fraction=0.976234
external_nav_max_invalid_streak=9
external_nav_invalid_reasons=route_match_not_valid:13
external_nav_session_ready=false
