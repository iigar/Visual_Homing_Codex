...
- Near-term priority: add perturbation checks against recorded `VHRS` artifacts; desktop builds must keep replay-first tests working and fail closed without camera backend.
