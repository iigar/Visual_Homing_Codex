...
- Near-term priority: inspect recorded `VHRS` route files through offline route reader/matcher tooling, then add a deterministic live-recording artifact check; desktop builds must keep replay-first tests working and fail closed without camera backend.
