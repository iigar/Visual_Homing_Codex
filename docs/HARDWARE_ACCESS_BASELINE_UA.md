...
Later on `2026-07-27`, the same strictly verified Pi fast-forwarded to exact commit `135942f` and completed a clean all-output-off build plus CTest `46/46` in `1400 s`, including the new fail-closed live-route verification composition test. Repository status remained clean and `get_throttled=0x0`. Evidence: `/home/pi/Visual_Homing_Codex/artifacts/logs/test-core-pi-20260726T225735Z.log`, `20870` bytes, SHA-256 `88d6cacaa5e3c24f4a5333b2b93e191d26056affcefad3893adaa75e6dbacd99`. This did not open FC UART or revalidate the `2026-07-18` FC/RC state. The Pi was subsequently fast-forwarded to evidence-only documentation commit `2d90dac`, remained clean and reported throttle `0x0`; no new CTest claim was attached to that fast-forward. No newer hardware connection was made during the `2026-08-13` documentation reconciliation; all hardware facts therefore remain timestamped, not live guarantees.
